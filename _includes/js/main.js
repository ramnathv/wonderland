...
(function() {
  var close_all_modals, dribbble_template, first_active, github_template, instagram_template, render_dribbble, render_github, render_instagram, render_twitter, reset_active_nav, set_active_nav, show_dribbble, show_github, show_instagram, show_profile, show_twitter, twitter_template;
  ...
  render_dribbble = function(data) {
    ...
    return $("#dribbble-link").parent().removeClass('loading');
  };
  ...
  $(document).on("show", ".dribbble.modal", function() {
    return set_active_nav($("#dribbble-link").parent());
  });
